...
app.layout = html.Div([
    html.H1("CALCULA TU PRESUPUESTO"),
    html.Button('INSTALACION DE TUBERIAS', id='go-to-form-button-tuberias', style={'margin-right': '10px'}),
    html.Button('ESPACIO PUBLICO', id='go-to-form-button-espacio', style={'margin-right': '10px'}),
